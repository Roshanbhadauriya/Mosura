       ...
       <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center pt-20">
         ...
         >
           <motion.div variants={topRevealVariants}>
             <div className="inline-flex items-center gap-2 rounded-full border border-[rgba(237,127,24,0.35)] bg-black/50 px-3 py-1 text-[11px] font-medium tracking-tight text-orange-100/80 backdrop-blur">
