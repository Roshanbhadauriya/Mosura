      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-6">
          ...
          >
            ...
            >
              <Card className="rounded-2xl border border-border/60 bg-card/80 px-3 py-1 text-xstracking-[0.32em] text-muted-foreground shadow-[0_10px_30px_-20px_rgba(15,23,42,0.8)]">
                Brand
              </Card>
              <Badge
                variant="outline"
